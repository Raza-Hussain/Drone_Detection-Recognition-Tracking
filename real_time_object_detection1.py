		...
		if confidence > args["confidence"]:
			...
			if (idx == 15):
                                ...
                                if (count == 1):
                                         ...
                                         height = endY - startY
                                         Area = height * width
                                         print ("area of first frame" , Area)
                                         print("start x of current frame" , startX)
                                         label = "{}: {:.2f}%".format(CLASSES[idx],
                                         confidence * 100)
                                ...
                                if (count == 4):       
                                        box = detections[0, 0, i, 3:7] * np.array([w, h, w, h])
                                        (startX, startY, endX, endY) = box.astype("int")
                                        x_cordinate_next = [startX,endX]
                                        X_next = startX
                                        width_f = endX - startX
                                        height_f = endY - startY
                                        Area_f = height_f * width_f
                                        print("area of the next frame" , Area_f)
                                        print ("start x of the next frame" , startX)
                                        label = "{}: {:.2f}%".format(CLASSES[idx],
                                        confidence * 100)
